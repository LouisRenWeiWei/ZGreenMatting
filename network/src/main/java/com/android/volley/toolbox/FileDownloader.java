...
public class FileDownloader {
	 ...
	 */
	public FileDownloadRequest buildRequest(String storeFilePath, String url,Listener listener) {
		return new FileDownloadRequest(storeFilePath, url,listener);
	}

	/**
	 * This class included all such as PAUSE, RESUME, DISCARD to manipulating download task,
	 * it created by {@link FileDownloader#add(String, String, com.android.volley.listener.Listener)},
	...
	public class DownloadController {
		...
		private boolean deploy() {
			...
			mRequest = buildRequest(mStoreFilePath, mUrl,listener);
