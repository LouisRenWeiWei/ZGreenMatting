...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use {@link #Request(int, String, com.android.volley.listener.Listener)}.
     */
    @Deprecated
    public Request(String url, Listener listener) {
     ...
     */
    public Request(int method, String url, Listener listener) {
        mMethod = method;
        mUrl = url;
        mListener = listener;
    ...
    public void deliverProgress(long fileSize, long downloadedSize) {
        if (mListener != null) {
